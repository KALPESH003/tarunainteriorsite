...
export default function FullPortfolioClient({ project }) {
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
          {project.gallery.map((imgUrl, index) => (
            <motion.div
              ...
              className="break-inside-avoid relative w-full rounded-[2rem] overflow-hidden group cursor-pointer bg-zinc-900 border border-white/5 shadow-sm"
            >
      ...
      <AnimatePresence>
        {selectedIndex !== null && (
          ...
          >
            ...
            <button className="absolute left-4 md:left-10 z-[1100] w-14 h-14 bg-white/5 border border-white/10 rounded-full flex items-center justify-center hover:bg-white/10 transition-colors" onClick={prevMedia}>
              <ChevronLeft className="w-8 h-8 text-white" />
            </button>
            <button className="absolute right-4 md:right-10 z-[1100] w-14 h-14 bg-white/5 border border-white/10 rounded-full flex items-center justify-center hover:bg-white/10 transition-colors" onClick={nextMedia}>
            ...
            <motion.div 
              ...
              className="relative w-full max-w-7xl h-full max-h-[85vh] rounded-3xl overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.9)] flex items-center justify-center"
