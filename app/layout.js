...
export const metadata = {
  ...
  keywords: ['Taruna Interiors', 'Taruna Interior', 'Taruna Interior Gallery', 'Best interior designers in Vadodara', 'Top interior designers in Vadodara', 'Luxury Interior Design', 'Vadodara Interiors', 'Bespoke Design', 'Pan India'],
  openGraph: {
    title: 'Taruna Interiors',
