        ...
        >
          ...
          >
            <div className="relative w-6 h-6 lg:w-8 lg:h-8 flex items-center justify-center bg-black rounded-full overflow-hidden shrink-0">
              <div className="absolute flex items-center justify-center transform transition-transform duration-500 group-hover:translate-x-full">
                <ArrowLeft className="w-3 h-3 lg:w-4 lg:h-4 text-white" />
              </div>
              <div className="absolute flex items-center justify-center transform -translate-x-full transition-transform duration-500 group-hover:translate-x-0">
                <ArrowLeft className="w-3 h-3 lg:w-4 lg:h-4 text-white" />
              </div>
            </div>
...
//       {/* --- GIANT STRUCTURAL 404 WATERMARK --- */}
//       {/* It sits perfectly centered, massive, and blends into the background */}
//       <motion.div 
//         initial={{ opacity: 0, scale: 0.95 }}
//         animate={{ opacity: 1, scale: 1 }}
//         transition={{ duration: 2, ease: "easeOut" }}
...
//             className="flex items-center gap-4"
//           >
//             <span className="w-2 h-2 bg-[#c9a071] rounded-full animate-pulse" />
//             <span className="text-[10px] uppercase tracking-[0.3em] font-medium text-gray-400">
//               Uncharted Territory
//             </span>
//           </motion.div>
...
//           <Link 
//             href="/" 
//             className="group flex items-center gap-6 bg-white text-black px-6 py-4 lg:px-8 lg:py-5 rounded-full overflow-hidden hover:bg-[#c9a071] transition-colors duration-500"
//           >
//             <div className="relative w-6 h-6 lg:w-8 lg:h-8 flex items-center justify-center bg-black rounded-full overflow-hidden shrink-0">
//               {/* The arrow slides in from the left on hover */}
//               <div className="absolute flex items-center justify-center transform transition-transform duration-500 group-hover:translate-x-full">
//                 <ArrowLeft className="w-3 h-3 lg:w-4 lg:h-4 text-white" />
//               </div>
//               <div className="absolute flex items-center justify-center transform -translate-x-full transition-transform duration-500 group-hover:translate-x-0">
