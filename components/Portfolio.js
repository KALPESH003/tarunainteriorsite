...
// We define the top 4 featured projects here for the homepage grid
...
export default function Portfolio() {
  return (
    <section id="portfolio" className="bg-white py-32 px-6 md:px-12 relative z-20 w-full overflow-hidden border-t border-gray-100">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brand-blue/5 blur-[150px] rounded-full pointer-events-none z-0 -translate-y-1/2 translate-x-1/3" />
        ...
        >
          <div>
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="text-brand-blue text-[11px] uppercase tracking-[0.25em] font-bold">Signature Work</span>
            </div>
          ...
          <Link href="/portfolio" className="group flex items-center gap-4 pb-2 relative overflow-hidden shrink-0">
            <span className="text-gray-900 font-bold text-[11px] tracking-[0.2em] uppercase relative z-10 transition-colors group-hover:text-brand-blue">
              View All Projects
            </span>
            <div className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center group-hover:border-brand-blue group-hover:bg-brand-blue/10 transition-all duration-500">
              <ArrowUpRight className="w-4 h-4 text-gray-900 group-hover:text-brand-blue transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-500" />
            </div>
          </Link>
        </motion.div>
          ...
          {featuredProjects.map((project) => (
            ...
            >
              ...
              <div className="flex items-start justify-between px-2">
                <div>
                  <h3 className="text-2xl font-serif text-gray-900 mb-2 group-hover:text-brand-blue transition-colors duration-300">
                    {project.title}
                  </h3>
...
//               <span className="text-brand-blue text-[11px] uppercase tracking-[0.25em] font-bold">Signature Work</span>
//             </div>
//             {/* Swapped text-white for text-gray-900 */}
//             <h2 className="text-gray-900 text-4xl md:text-5xl lg:text-[56px] font-serif font-medium leading-[1.1] tracking-tight">
//               A Legacy of <br />
//               <span className="italic text-gray-400 font-light">Masterpieces.</span>
//             </h2>
...
//               View All Projects
//             </span>
//             {/* Adjusted border to border-gray-200 */}
//             <div className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center group-hover:border-brand-blue group-hover:bg-brand-blue/10 transition-all duration-500">
//               <ArrowUpRight className="w-4 h-4 text-gray-900 group-hover:text-brand-blue transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-500" />
//             </div>
//           </Link>
...
//                 {/* Image Overlay - Kept dark so the white Explore button stands out */}
//                 <div className="absolute inset-0 bg-black/10 group-hover:bg-black/30 transition-colors duration-700 pointer-events-none" />
                
//                 {/* Center "Explore" Button (Reveals on Hover) */}
//                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 rounded-full bg-black/50 backdrop-blur-md border border-white/20 flex flex-col items-center justify-center opacity-0 scale-75 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 ease-out z-20">
//                   <span className="text-white text-[10px] font-bold uppercase tracking-[0.2em] mb-2">Explore</span>
//                   <ArrowUpRight className="w-5 h-5 text-brand-blue" />
//                 </div>
